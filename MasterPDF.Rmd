...
GET and OAuth token is generated based on the package [httr](https://cran.r-project.org/web/packages/httr/index.html), while [jsonlite](https://cran.r-project.org/web/packages/jsonlite/index.htm)
...
[Flickr Report](.\Flickr\FlickrMaster.pdf)
...
*   [Exif Tool Exploration:](.\ProcessingImages\Images.pdf) This is a windows application based on
    the Exif PERL library which allows the extraction of metadata for
    images.
    

*   [Prophet Package Exploration:](.\ProphetPackageExploration\Exploring_Prophet.pdf) This is a facebook package that is used to
