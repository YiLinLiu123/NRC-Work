---
title: "Facebook Draft Report V3"
author: "paul"
date: "March 3, 2017"
output:
  html_document:
...
such as profile information, user posts and comments etc. are not 
...
*   It is easy to access public data of Facebook through its [__search API__](https://developers.Facebook.com/docs/graph-api/using-graph-api#search). Part
of the functionality is covered by the _RFacebook_ package through the _searchGroup &
searchPages_ function.
Information such as public pages, posts, comments and replies to comments can 
be easily accessed providing the Id is known.

*   It was observed that many pages, posts and comments
    does not include _location_ information as part of its content.

*   It is __recommended__ to use the access token created through a developer's application. 
There is no expiration date for this type of access token. 

*   The [graph API Explorer](https://developers.Facebook.com/tools/explorer/) tool is useful for testing API calls to understand structure 
